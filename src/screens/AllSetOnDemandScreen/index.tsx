...
export function AllSetOnDemandScreen() {
  ...
  return (
    <View style={styles.root}>
      <ImageBackground source={BG} style={styles.bg} resizeMode="cover">
        ...
        {/* Bottom sheet — edge to edge, no side margins */}
        <LinearGradient
        ...
        >
          ...
          <View style={[styles.inner, { paddingBottom: insets.bottom + 24 }]}>
            ...
            <Text style={styles.caption}>Your passes are ready to use from today</Text>
            ...
            <View style={styles.kycCard}>
              <Text style={styles.kycTitle}>Complete KYC to access the building</Text>
              <Text style={styles.kycSubtitle}>
                KYC is required for entry and security.{'\n'}It takes less than 2 minutes.
              </Text>
            </View>

            {/* Buttons */}
            <OrangeButton
              label="Complete KYC & Get Access"
...
const styles = StyleSheet.create({
  ...
  // Sheet — absolutely positioned, truly edge to edge
  sheet: {
    position: 'absolute',
    bottom: 0,
    left: 0,
  ...
  // Inner content — this has the horizontal padding
  inner: {
